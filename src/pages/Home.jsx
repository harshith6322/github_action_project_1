    ...
    <div className={styles.container} ref={scrollRef} data-scroll-container>
      ...
      >
        ...
        <div className={styles.image_bg}>
          <div
            data-scroll
            data-scroll-speed={windowWidth > 700 ? "1.5" : "0.8"}
            className={styles.div}
          >
            <img
              loading="eager"
              className={styles.img_1}
              src="https://res.cloudinary.com/dvk80x6fi/image/upload/v1720959889/image_transparent_Craiyon_7_zpbwaf.png"
              alt="Image 1"
            />
          </div>
          <div
            data-scroll
            data-scroll-speed={windowWidth > 700 ? "1.9" : "1.1"}
            className={styles.div}
          >
            <img
              loading="eager"
              className={styles.img_2}
              src="https://res.cloudinary.com/dvk80x6fi/image/upload/v1720958233/image_transparent_Craiyon_5_orvr2p.png"
              alt="Image 2"
            />
          </div>
          <div
            data-scroll
            data-scroll-speed={windowWidth > 700 ? "2.5" : "1.3"}
            className={styles.div}
          >
            <img
              loading="eager"
              className={styles.img_3}
              src="https://res.cloudinary.com/dvk80x6fi/image/upload/v1720329633/cup-1_transparent_Craiyon_oddwqr.png"
              alt="Image 3"
            />
          </div>
          <div
          ...
          >
            <img
              ...
              src="https://res.cloudinary.com/dvk80x6fi/image/upload/v1720958351/image_transparent_Craiyon_4_frmtvj.png"
              alt="Image 4"
            />
          </div>
          <div
      ...
      <section ref={bestSellerRef} className={styles.best_sellers} data-scroll>
        ...
        <h2 data-scroll style={{ fontWeight: "600" }}>
          BEST SELLERS
        </h2>
        <div className={styles.best_seller_con}>
              ...
              return (
                ...
                >
                  <h3
                    ...
                    onClick={() => setBestSellerSelected(index)}
                  >
                    {data.name}
                  </h3>
                </FramerMotion>
          ...
          <Link
            ...
            to={"/"}
            className={`${styles.image_con} allow_hover`}
          >
            <FramerMotion
              className={"height_li"}
              width={"100%"}
      ...
      >
        <FramerMotion
          ...
          overflowHidden={"hidden"}
        >
          <h2 style={{ marginBottom: "0px" }}>CATEGORIES</h2>
        </FramerMotion>
        ...
        <div style={{ width: "100%", marginTop: "30px" }}>
          ...
          >
            {" "}
            <h2 style={{ marginBottom: "0px", width: "100%" }}>
              Products
            </h2>{" "}
          </FramerMotion>
      ...
      <section className={styles.features} ref={contentRef} data-scroll>
        <div className={styles.about_frame}>
          ...
          <div className={`${styles.content} content-section`}>
            <h4>
              We make every coffee{" "}
              <span>
                <SiBuymeacoffee />
              </span>{" "}
              with our Heart. <AiFillHeart />
            </h4>
          </div>
        </div>
      ...
      <section className={styles.features_mob} data-scroll>
        ...
        >
          <figure className={styles.normal}>
            <figcaption>
              <h4>
                We only use best and <SiCodefresh /> fresh ingredients.{" "}
                <IoIosArrowRoundDown className={styles.arrow} />
              </h4>
            </figcaption>
            h
        ...
        >
          ...
          >
            <figcaption>
              <h4>
                Maintaining Hygien <IoFastFoodSharp /> is our top most priority.{" "}
                <IoIosArrowRoundDown className={styles.arrow} />
              </h4>
            </figcaption>
            <div className={styles.mob_image}>
        ...
        >
          <figure className={styles.normal}>
            <figcaption>
              <h4>
                We make every coffee <SiBuymeacoffee /> with our Heart.{" "}
                <AiFillHeart />
              </h4>
            </figcaption>
            <div className={styles.mob_image}>
      ...
      <section className={styles.community} ref={reviewsRef} data-scroll>
        ...
        <InfiniteScroll
          direction={"right"}
          data={communityPosts.slice(0, 10)}
        />
        ...
        <div className={styles.faqs}>
          {faqData.map((item, index) => (
            <FramerMotion
              ...
              overflowHidden={"none"}
              xAxis={200}
              type={index % 2 === 0 ? "leftToRight" : "rightToLeft"}
              animateOnces={false}
            >
              <FAQBox
                key={index}
      ...
      <section className={styles.about_coffee} data-scroll>
        <div className={styles.image_div}>
          <div>
            ...
            >
              {" "}
              <h6>Art & Science Of Coffee Brewing </h6>
            </FramerMotion>
            <FramerMotion
              type={"topToBottom"}
              overflowHidden={"hidden"}
            ...
            <FramerMotion
              ...
              animateOnces={false}
            >
              <button className="allow_hover">Learn More</button>
            </FramerMotion>
          </div>
        </div>
      </section>
