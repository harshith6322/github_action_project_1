  ...
  return (
    <header className={styles.header}>
      <nav className={styles.navbar_main_container}>
        ...
        <div
          className={`${styles.navbar_content_container} ${isMenuOpen ? styles.open : ""}`}
        >
          ...
          <div className={styles.user_items}>
            <Link to="/" onClick={toggleStoreLocator}>
      ...
      <ul className={` ${styles.mob_links} ${isMenuOpen && styles.show}`}>
        ...
        <li>
          <Link to="/">
            <BsFillCreditCard2FrontFill /> Gift Cards
          </Link>
        </li>
        <li>
          <Link to="/">
            {" "}
            <IoStorefrontSharp /> Find a Store
          </Link>
        </li>
